    ...
    <>
      ...
      <Container>
        ...
        <div className="prose mx-auto mt-12 dark:prose-invert">
          ...
          <p>
            ブラウザユーザーエージェント文字列とは、「どのブラウザからこのサイトにたどり着いたか」を表すものです。「Firefoxからたどり着いたのか」「Google
            Chromeからたどり着いたのか」を識別することが出来ます。
          </p>
          <p>
            これにより次回コメントを残す際に、「名前」や「メールアドレス」が自動的に表示されるため、それらを再入力する手間を省くことができます。
          </p>
          <p>
            メールアドレスから作成される匿名化された （「ハッシュ」とも呼ばれる）文字列は、訪問者が
            Gravatar
          ...
          <p>
            訪問者は、広告設定で訪問者に合わせた広告（以下、「パーソナライズド広告」とします。）を無効にすることが出来ます。その設定をする場合は、こちらをクリックしてください。また、www.aboutads.info
